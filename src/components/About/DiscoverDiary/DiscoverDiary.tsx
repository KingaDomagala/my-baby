        ...
        <div className="bg-light-grey py-16">
            <div className="container mx-auto px-4">
                <div className="flex flex-col">
                    ...
                    <p className="text-base leading-[150%] font-light mb-8">Nasz dziennik to idealne narzędzie, które pozwala rodzicom dokumentować najważniejsze chwile w życiu ich dziecka. Dzięki możliwości dodawania zdjęć oraz osobistych notatek, staje się on nie tylko pamiątką, ale także źródłem radości w przyszłości.</p>
                    <DiscoverDiaryList />
                </div>
            </div>
        </div>
