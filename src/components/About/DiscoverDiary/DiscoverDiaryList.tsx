    ...
    const discoverDiaryList: TDiscoverDiaryList[] = [
        {
            ...
            description: "Dodawaj zdjęcia oraz wpisy tekstowe, zapisuj myśli i emocje w jednym bezpiecznym miejscu.",
        ...
        },
        {
            ...
            description: "Twórz wpisy dziennika, wracaj do wcześniejszych chwil i uzupełniaj historię wtedy, gdy chcesz.",
        ...
        },
        {
            ...
            description: "Przeglądaj zapisane wspomnienia, obserwuj zmiany i wracaj do momentów szczególnie ważnych.",
