    ...
    const discoverDiaryList: TDiscoverDiaryList[] = [
        {
            ...
            description: "Dodawaj zdjęcia oraz krótkie lub dłuższe wpisy. Zapisuj myśli, emocje i ważne chwile w jednym, bezpiecznym miejscu.",
        ...
        },
        {
            ...
            description: "Każdy wpis to fragment Waszej historii. Twórz nowe zapiski i wracaj do wcześniejszych wtedy, gdy masz na to czas.",
        ...
        },
        {
            ...
            description: "Przeglądaj zapisane chwile i obserwuj zmiany. Zobacz, jak z małych momentów powstaje pełna opowieść.",
