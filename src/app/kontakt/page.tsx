...
const ContactPage = () => {
    return (
        <GeneralContainer image="/images/contact.png" alt="Kontakt" containerClassName="bg-light-grey" afterColorClassName="lg:after:bg-brown" decorations={<ContactDecorations />}>
            ...
            <p className="text-base leading-[150%] font-light mb-8">Napisz do nas, chętnie odpowiemy oraz pomożemy w korzystaniu z dziennika. Jesteśmy tu, aby wspierać Cię na każdym etapie tworzenia wspomnień.</p>
            <ContactForm />
        </GeneralContainer>
    );
};
